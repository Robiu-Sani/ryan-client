        ...
        <div className=" md:w-9/12 mx-auto bg-white pb-10 border border-gray-300">
          <div className="flex justify-between items-center gap-5 md:gap-0 bg-[#6F6F6F] text-white py-1 px-2 md:px-4">
            <div className="flex items-center justify between text-sm font-bold gap-1 md:gap-3">
              ...
              <p className="text-[#6F6F6F] bg-white text-center  md:p-2 border-2 border-[#C7C7C7] shadow-sm text-xs md:text-base">
                Estimated Power Consumption 0W
              </p>
            </div>
            <div>
              <FaSyncAlt className="md:mr-4" />
            </div>
          </div>
          ...
          {infos.map((info, index) => (
            <div
              key={index}
              className="flex justify-between items-center py-4 px-3 border-b-[1.5px] border-[#CCCCCC]"
            >
              ...
              <div className="border border-[#C7C7C7] rounded-full py-[6px] px-4 text-sm hover:bg-[#72BF44] hover:text-white transition-all">
                Select
              </div>
            </div>
          ))}
